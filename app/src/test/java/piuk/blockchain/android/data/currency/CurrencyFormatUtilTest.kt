...
class CurrencyFormatUtilTest {
    ...
    fun `formatFiatWithSymbol`() {
        // Assert
        assertEquals("$100,000.00", subject.formatFiatWithSymbol(100_000.00, "USD", Locale.getDefault()))
        assertEquals("$0.00", subject.formatFiatWithSymbol(0.0, "USD", Locale.getDefault()))
    }
}