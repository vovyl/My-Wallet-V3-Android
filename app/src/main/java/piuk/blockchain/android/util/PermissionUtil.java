...
public class PermissionUtil {
    ...
    public static final int PERMISSION_REQUEST_WRITE_STORAGE_AND_CAMERA = 163;
    ...
    public static void requestWriteStorageAndCameraPermissionFromActivity(View parentView, final Activity activity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            Snackbar.make(parentView, activity.getString(R.string.request_write_storage_permission),
                ...
                ActivityCompat.requestPermissions(activity,
                        ...
                        PERMISSION_REQUEST_WRITE_STORAGE_AND_CAMERA);
            }).setActionTextColor(ContextCompat.getColor(parentView.getContext(), R.color.primary_blue_accent))
                    .show();
